...
case class Tag(@Key("_id") id: String, var timeLastViewed: String, @Ignore var byLineImageUrl:String ="", @Ignore var count: Int = 0, @Ignore var content: List[Content] = List())
